...
impl HostTexture {
    pub fn empty(name: String, width: usize, height: usize, depth: usize) -> HostTexture {
        HostTexture {
            name,
            width,
            height,
...
impl DeviceTexture {
    pub fn new(host_texture: &HostTexture, desc: &Descriptor) -> Rc<DeviceTexture> {
...
impl Descriptor {
    pub fn new(desc_type: DescriptorType) -> Descriptor {
        match desc_type {
            DescriptorType::Color(host_texture) => Descriptor {
            ...
            DescriptorType::Depth => Descriptor {
                target: gl::TEXTURE_2D,
            ...
            DescriptorType::ColorAttachment => Descriptor {
                target: gl::TEXTURE_2D,
                s_wrap: gl::CLAMP_TO_EDGE,
                t_wrap: gl::CLAMP_TO_EDGE,
                r_wrap: gl::CLAMP_TO_EDGE,
            ...
            DescriptorType::SphericalHdri(host_texture) => Descriptor {
                target: gl::TEXTURE_2D,
                s_wrap: gl::CLAMP_TO_EDGE,
                t_wrap: gl::CLAMP_TO_EDGE,
                r_wrap: gl::CLAMP_TO_EDGE,
            ...
            DescriptorType::PrefilteredEnvMap => Descriptor {
                target: gl::TEXTURE_2D,
                s_wrap: gl::CLAMP_TO_EDGE,
                t_wrap: gl::CLAMP_TO_EDGE,
                r_wrap: gl::CLAMP_TO_EDGE,
